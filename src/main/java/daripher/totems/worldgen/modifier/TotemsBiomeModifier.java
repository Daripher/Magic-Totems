...
public class TotemsBiomeModifier implements BiomeModifier
{
	...
	{
		return RecordCodecBuilder.create(builder -> builder.group(TagKey.codec(Registry.BIOME_REGISTRY).fieldOf("biomes").forGetter(TotemsBiomeModifier::getBiomes),
				ResourceLocation.CODEC.fieldOf("feature").forGetter(TotemsBiomeModifier::getPlacedFeatureId)).apply(builder, TotemsBiomeModifier::new));
	}
}
