...
public class TotemsBiomeModifiers
{
	...
	public static final RegistryObject<BiomeModifier> UNDERGROUND_TOTEMS = REGISTRY.register("underground_totems", () -> new TotemsBiomeModifier(Biomes.IS_OVERWORLD, TotemsPlacedFeatures.UNDERGROUND_TOTEMS.getId()));
